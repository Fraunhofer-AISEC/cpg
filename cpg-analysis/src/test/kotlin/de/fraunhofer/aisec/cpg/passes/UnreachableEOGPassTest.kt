...
class UnreachableEOGPassTest {
    ...
    fun testIfBothPossible() {
        ...
        val ifStatement = method.dIfs.firstOrNull()
    ...
    fun testWhileTrueEndless() {
        val method = tu.dFunctions["whileTrueEndless"]
        assertNotNull(method)

        val whileStatement = method.dWhileLoops.firstOrNull()
    ...
    @Test
    fun testWhileTrue() {
        val method = tu.dFunctions["whileTrue"]
        assertNotNull(method)
    ...
    fun testWhileComputedTrue() {
        val method = tu.dFunctions["whileComputedTrue"]
        assertNotNull(method)
    ...
    @Test
    fun testWhileFalse() {
        val method = tu.dFunctions["whileFalse"]
        assertNotNull(method)
    ...
    fun testWhileComputedFalse() {
        val method = tu.dFunctions["whileComputedFalse"]
        assertNotNull(method)
    ...
    fun testWhileUnknown() {
        val method = tu.dFunctions["whileUnknown"]
        assertNotNull(method)

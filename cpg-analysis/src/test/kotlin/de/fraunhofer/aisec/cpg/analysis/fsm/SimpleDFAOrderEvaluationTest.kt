...
class SimpleDFAOrderEvaluationTest {
    ...
    fun testSuccessForFSM() {
        ...
        val p4Decl = functionOk.bodyOrNull<de.fraunhofer.aisec.cpg.graph.ast.statements.DeclarationStatement>(0)
    ...
    fun testFailWrongStartFSM() {
        ...
        val pDecl = functionOk.bodyOrNull<de.fraunhofer.aisec.cpg.graph.ast.statements.DeclarationStatement>(0)
        assertNotNull(pDecl)

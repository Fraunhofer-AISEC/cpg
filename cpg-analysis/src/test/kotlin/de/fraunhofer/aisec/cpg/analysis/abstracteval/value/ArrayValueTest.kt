...
class ArrayValueTest {
    ...
    fun applyDeclarationTest() {
        ...
        assertEquals(
            ...
            Array().applyEffect(current, correctDeclaration, name.localName)
        )
        ...
        assertEquals(
            ...
            Array().applyEffect(current, wrongNameDeclaration, name.localName)
        )
        ...
        assertEquals(
            LatticeInterval.Bounded(1, 1),
            Array().applyEffect(current, noInitializerDeclaration, name.localName)
        )
    }
}

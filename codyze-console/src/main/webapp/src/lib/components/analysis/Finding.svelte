...
<li class="py-3">
  ...
  <p class="text-gray-700">
    ...
    {#if finding.component && finding.translationUnit}
      <a
        href={`/components/${finding.component}/translation-unit/${finding.translationUnit}?line=${finding.startLine}&finding=${getText(finding)}&kind=${finding.kind.toLowerCase()}`}

...
class LLVMIRLanguageFrontendTest {
    ...
    fun testIdentifiedStruct() {
        ...
        val rt = tu.dRecords["struct.RT"]
        assertNotNull(rt)

        val st = tu.dRecords["struct.ST"]
        assertNotNull(st)
        ...
        val arrayidx = foo.dVariables["arrayidx"]
    ...
    fun testSwitchCase() {
        ...
        val switchStatement = main.dSwitches.firstOrNull()
    ...
    fun testBrStatements() {
        ...
        // Check that the jump targets are set correctly
        val ifStatement = main.dIfs.firstOrNull()
    ...
    fun testCmpxchg() {
        ...
        assertRefersTo(thenExpr.rhs.first(), tu.dVariables["old1"])
    }
    ...
    fun testExtractvalue() {
        ...
        val declaration = foo.dVariables["value_loaded"]
    ...
    fun testLiteralStruct() {
        ...
        val returnStatement = foo.dReturns.singleOrNull()
    ...
    fun testAlloca() {
        ...
        // store i32 3, i32* %ptr
        val store = main.dAssigns.firstOrNull()
        assertNotNull(store)
    ...
    fun testUndefInsertvalue() {
        ...
        val block = foo.dBlocks.firstOrNull()
        assertNotNull(block)

        // First copy a to b
        val b = block.dVariables["b"]
        assertNotNull(b)
        assertLocalName("b", b)
        assertEquals("literal_i32_i8", b.type.typeName)

        // Now, we set b.field_1 to 7
        val assign = block.dAssigns.firstOrNull()
    ...
    fun testTryCatch() {
        ...
        val throwingFoo = tu.dFunctions["throwingFoo"]
    ...
    fun testLoopPhi() {
        ...
        val main = tu.dFunctions["loopPhi"]
        assertNotNull(main)
    }
    ...
    fun testExceptions() {
        ...
        val funcF = tu.dFunctions["f"]
        assertNotNull(funcF)

        val tryStatement = funcF.bodyOrNull<LabelStatement>(0)?.subStatement?.dTrys?.firstOrNull()

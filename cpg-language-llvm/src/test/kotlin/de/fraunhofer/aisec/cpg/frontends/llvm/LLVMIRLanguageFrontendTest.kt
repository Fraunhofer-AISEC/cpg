...
class LLVMIRLanguageFrontendTest {
    ...
    fun testPhi() {
        ...
        assertIs<Return>(returnStatement)
    ...
    fun testExceptions() {
        ...
        val tryStatement = funcF.bodyOrNull<Label>(0)?.subStatement?.trys?.firstOrNull()

...
public class VariableResolverCppTest {
    ...
    public void testOuterVarNameAccessedImplicitThis() {
        MemberExpression asMemberExpression = getCallWithMemberExpression("func1_impl_this_varName"); // instance_field
        assertNotNull(asMemberExpression);
    }

    @Test
    public void testStaticFieldAccessedImplicitly() {
        DeclaredReferenceExpression asReference = getCallWithReference("func1_static_staticVarName"); // static_field");
        assertNotNull(asReference);
    }

    @Test
    public void testVarNameOfFirstLoopAccessed() {
        DeclaredReferenceExpression asReference = getCallWithReference("func1_first_loop_varName"); // first_loop_local
        assertNotNull(asReference);
    }

    @Test
    public void testAccessLocalVarNameInNestedBlock() {
        DeclaredReferenceExpression asReference = getCallWithReference("func1_nested_block_shadowed_local_varName"); // local_in_inner_block
        assertNotNull(asReference);
    }

    @Test
    public void testVarNameOfSecondLoopAccessed() {
        DeclaredReferenceExpression asReference = getCallWithReference("func1_second_loop_varName"); // second_loop_local
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func2_param_varName"); // parameter
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func2_this_varName"); // instance_field
        assertNotNull(asReference);
    }
    ...
    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func2_catch_varName"); // exception_string
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func2_instance_varName"); // instance_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func2_imp_this_varName"); // parameter
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func3_instance_varName"); // instance_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func3_external_instance_varName"); // external_instance_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func4_static_staticVarName"); // static_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func4_external_staticVarName");  // external_static_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func4_external_instance_varName"); //  external_instance_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func4_second_external_staticVarName"); //external_static_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func1_inner_imp_this_varName"); // inner_instance_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func1_inner_instance_varName"); // inner_instance_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func1_outer_instance_varName"); // instance_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
            DeclaredReferenceExpression asReference = getCallWithReference("func1_outer_static_staticVarName"); // static_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
            DeclaredReferenceExpression asReference = getCallWithReference("func1_inner_static_staticVarName"); // inner_static_field
        assertNotNull(asReference);
    }
    ...
    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func2_inner_instance_varName_with_shadows"); // inner_instance_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func2_outer_instance_varName_with_shadows"); // instance_field
        assertNotNull(asReference);
    }
    ...
    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func2_outer_static_staticVarName_with_shadows"); // static_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("func2_inner_static_staticVarName_with_shadows"); // inner_static_field
        assertNotNull(asReference);
    }

    @Test
    public void test() {
        DeclaredReferenceExpression asReference = getCallWithReference("main_local_varName"); // parameter
        assertNotNull(asReference);
    }
}

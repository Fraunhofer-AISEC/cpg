...
class CpgSuggestConceptsPromptTest : McpTestSetup() {
    ...
    //        val result =
    //            client.getPrompt(GetPromptRequest(GetPromptRequestParams(name =
    // "suggest_concepts")))
    //
    ...
    //                        arguments = mapOf("description" to "We have some additional context
    // here."),
    //                    )
    //                )
    //            )

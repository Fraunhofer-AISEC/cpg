...
open class JavaLanguage(ctx: TranslationContext) :
    ...
    override val builtInTypes =
        mapOf(
            "void" to IncompleteType(ctx, language = this),
            // Boolean Types:
            // https://docs.oracle.com/javase/specs/jls/se19/html/jls-4.html#jls-4.2.5
            "boolean" to BooleanType(ctx, "boolean", language = this),
            "Boolean" to BooleanType(ctx, "java.lang.Boolean", language = this),
            "java.lang.Boolean" to BooleanType(ctx, "java.lang.Boolean", language = this),
            ...
            "char" to IntegerType(ctx, "char", 16, this, NumericType.Modifier.UNSIGNED),
            ...
            "java.lang.Integer" to
                IntegerType(ctx, "java.lang.Integer", 32, this, NumericType.Modifier.SIGNED),
            ...
            "String" to StringType(ctx, "java.lang.String", this),

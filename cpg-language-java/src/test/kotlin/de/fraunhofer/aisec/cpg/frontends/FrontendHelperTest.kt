...
class FrontendHelperTest {
    ...
    fun testCommentMatcher() {
        ...
        val constructorAssignment = (constructor.body as BlockStatement).statements[0]
        ...
        val forLoop = (mainMethod.body as BlockStatement).statements[0] as ForStatement
        ...
        val printStatement = (forLoop.statement as BlockStatement).statements.first()
        ...
        assertTrue((forLoop.statement as? BlockStatement)?.comment?.contains(comment9) == true)

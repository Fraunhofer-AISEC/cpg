...
class PHPLanguageFrontend(ctx: TranslationContext, language: PHPLanguage) :
    ...
    private fun parseParameters(parameterList: String, rawNode: String): List<de.fraunhofer.aisec.cpg.graph.declarations.Parameter> {
        ...
        return parameterList
            .split(",")
            .mapNotNull { parameterDeclaration ->
    ...
    companion object {
        private val FUNCTION_REGEX = Regex("""\bfunction\s+&?\s*([A-Za-z_][A-Za-z0-9_]*)\s*\(([^)]*)\)""")

...
class FormattedValueHandlerTest {
    ...
    fun testFormattedValues() {
        ...
        val aAssExpression = result.allVariables["a"]?.astParent
        ...
        val bAssExpression = result.allVariables["b"]?.astParent
        ...
        val cAssExpression = result.allVariables["c"]?.astParent
        ...
        val dAssExpression = result.allVariables["d"]?.astParent
        ...
        val eAssExpression = result.allVariables["e"]?.astParent

...
class FormattedValueHandlerTest {
    ...
    fun testFormattedValues() {
        ...
        val aAssExpression = result.variables["a"]?.firstAssignment?.astParent
        ...
        val bAssExpression = result.variables["b"]?.firstAssignment?.astParent
        ...
        val cAssExpression = result.variables["c"]?.firstAssignment?.astParent
        ...
        val dAssExpression = result.variables["d"]?.firstAssignment?.astParent
        ...
        val eAssExpression = result.variables["e"]?.firstAssignment?.astParent

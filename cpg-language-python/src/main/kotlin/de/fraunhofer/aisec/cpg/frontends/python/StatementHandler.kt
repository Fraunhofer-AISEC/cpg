...
class StatementHandler(frontend: PythonLanguageFrontend) :
     ...
     * [ast.statements.expressions.Block] which holds the [ast.statements.CaseStatement] and then
     * all other statements of the [Python.AST.match_case.body].
     *
     * The [ast.statements.CaseStatement] is generated by the [Python.AST.match_case.pattern] and,
     * if available, [Python.AST.match_case.guard]. A `guard` is modeled with an `AND`
     * BinaryOperator in the [ast.statements.CaseStatement.caseExpression]. Its `lhs` is the normal
     ...
     * [ast.statements.SwitchStatement].
     */
     ...
     * [ast.statements.ThrowExpression].
     */
     ...
     * [ast.statements.expressions.Block].
     *
     ...
     * [ast.statements.expressions.DeleteExpression].
     */
     ...
     * - A [ast.statements.expressions.Reference] to a variable with a random [Name]
     * - An [ast.statements.expressions.AssignExpression] assigning the reference above to the
     *   [loopVar] input
     *
     ...
     * [ast.statements.expressions.AssignExpression].
     */
     ...
     * [ast.statements.LookupScopeStatement].
     */
     ...
     * into a [ast.statements.LookupScopeStatement].
     */
    ...
    /**
     * This function "wraps" a list of [Python.AST.BaseStmt] nodes into a
     * [ast.statements.expressions.Block]. Since the list itself does not have a code/location, we
     * need to employ [codeAndLocationFromChildren] on the [parentNode].
     */
     ...
     *
     * @param decl The [ast.declarations.Declaration] to be wrapped

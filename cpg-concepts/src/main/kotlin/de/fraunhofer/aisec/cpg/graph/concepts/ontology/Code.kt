...
public open class Code(
    ...
    override fun equals(other: Any?): Boolean =
        other is Code &&
            super.equals(other) &&
            other.codeModules == this.codeModules &&
            other.codeRepository == this.codeRepository &&
            other.functionalities == this.functionalities

    override fun hashCode(): Int =
        Objects.hash(super.hashCode(), codeModules, codeRepository, functionalities)
}

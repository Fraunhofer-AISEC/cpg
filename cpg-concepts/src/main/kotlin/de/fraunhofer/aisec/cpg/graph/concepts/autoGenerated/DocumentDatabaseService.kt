...
public abstract class DocumentDatabaseService(
  ...
  parent: Resource?,
  underlyingNode: Node?,
) : DatabaseService(anomalyDetections, httpEndpoint, malwareProtection, activityLogging, storage,
    ips, ports, authenticity, computes, serviceMetadataDocument, transportEncryption,

...
public abstract class DocumentDatabaseService(
  ...
  id: String,
  parent: Resource,
) : DatabaseService(anomalyDetections, httpEndpoint, malwareProtection, storage, activityLogging,
    ports, ips, authenticity, serviceMetadataDocument, computes, transportEncryption,

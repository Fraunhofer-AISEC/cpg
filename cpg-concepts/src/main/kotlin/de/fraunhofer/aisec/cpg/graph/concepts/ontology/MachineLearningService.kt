...
public abstract class MachineLearningService(
    ...
    override fun equals(other: Any?): Boolean =
        other is MachineLearningService &&
            super.equals(other) &&
            other.machineLearnings == this.machineLearnings &&
            other.storage == this.storage

    override fun hashCode(): Int = Objects.hash(super.hashCode(), machineLearnings, storage)
}

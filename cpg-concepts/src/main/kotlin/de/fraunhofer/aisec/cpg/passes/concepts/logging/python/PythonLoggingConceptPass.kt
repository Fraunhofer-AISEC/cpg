...
class PythonLoggingConceptPass(ctx: TranslationContext) : ComponentPass(ctx) {
     ...
     * [de.fraunhofer.aisec.cpg.graph.expressions.expressions.Call]s as these are the relevant parts
     ...
     *
     * @param callExpression The [de.fraunhofer.aisec.cpg.graph.expressions.expressions.Call] to
     *   handle

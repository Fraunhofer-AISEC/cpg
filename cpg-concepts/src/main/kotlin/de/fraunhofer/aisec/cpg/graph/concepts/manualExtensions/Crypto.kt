 ...
 */
class RngGet(val rng: RNG, underlyingNode: Node?) : Operation(rng, underlyingNode)
...
class CMAC(val cipher: Cipher?, input: Input?, selectorKey: SelectorKey?, underlyingNode: Node?) :
...
class RSASignature(
    ...
    selectorKey: SelectorKey?,
    underlyingNode: Node?,
) : Signature(schemeName = "RSA", selectorKey = selectorKey, underlyingNode = underlyingNode)
...
class DSASignature(
    ...
    selectorKey: SelectorKey?,
    underlyingNode: Node?,
) : Signature(schemeName = "DSA", selectorKey = selectorKey, underlyingNode = underlyingNode)
...
class SlhDsaSignature(
    ...
    selectorKey: SelectorKey?,
    underlyingNode: Node?,
) : Signature(schemeName = "SLH-DSA", selectorKey = selectorKey, underlyingNode = underlyingNode)
...
class MlDsaSignature(
    ...
    selectorKey: SelectorKey?,
    underlyingNode: Node?,
) : Signature(schemeName = "ML-DSA", selectorKey = selectorKey, underlyingNode = underlyingNode)
...
class StatefulHashBasedSignature(
    ...
    selectorKey: SelectorKey?,
    underlyingNode: Node?,
) : Signature(schemeName = schemeName, selectorKey = selectorKey, underlyingNode = underlyingNode)

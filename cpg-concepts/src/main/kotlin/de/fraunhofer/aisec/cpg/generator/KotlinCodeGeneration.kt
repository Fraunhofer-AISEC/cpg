...
private val objectPropertySpecialTypes: Map<String, TypeName> =
    mapOf(
        ...
        "Concept" to ClassName("de.fraunhofer.aisec.cpg.graph.concepts", "Concept"),
        "Agnostic" to ClassName("de.fraunhofer.aisec.cpg.graph.autoGenerated", "Agnostic"),
        ...
        "OperatingSystemArchitecture" to
            ClassName("de.fraunhofer.aisec.cpg.graph.concepts.arch", "OperatingSystemArchitecture"),
        "Operation" to ClassName("de.fraunhofer.aisec.cpg.graph.concepts", "Operation"),
    )

private val objectPropertyAutoGeneratedTypes: Set<String> =
    setOf(
        "AccessRestriction",
        "ActivityLogging",
        "Allocate",
...
private fun extractObjectProperties(objectProp: Properties): TypeName {
    ...
    return when {
        type == "[]Resource" -> ARRAY.parameterizedBy(autoGeneratedClass("Resource"))
        type in objectPropertyAutoGeneratedTypes -> autoGeneratedClass(type)

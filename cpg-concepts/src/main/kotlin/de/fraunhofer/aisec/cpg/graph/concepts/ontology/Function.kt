...
public abstract class Function(
    ...
    override fun equals(other: Any?): Boolean =
        other is Function &&
            super.equals(other) &&
            other.runtimeLanguage == this.runtimeLanguage &&
            other.runtimeVersion == this.runtimeVersion

    override fun hashCode(): Int = Objects.hash(super.hashCode(), runtimeLanguage, runtimeVersion)
}

...
class DynamicLoadingTest {
    ...
    fun testCXXPOSIX() {
        ...
        val myFunc = result.allFunctions["myfunc"]
        assertNotNull(myFunc)

        val lib = result.allVariables["lib"]
        assertNotNull(lib)
    ...
    fun testCXXWin32() {
        ...
        val dllMain = result.allFunctions["DllMain"]

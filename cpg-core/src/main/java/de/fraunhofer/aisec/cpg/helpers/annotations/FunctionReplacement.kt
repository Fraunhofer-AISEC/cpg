...
/**
 * This annotation is used to mark functions which translate instructions/statements to special
 * functions which do not actually exist in the respective language.
 *

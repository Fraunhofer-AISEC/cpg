...
class WhileStatement : Statement() {
    ...
    @SubGraph("AST")
    var conditionDeclaration: Declaration? = null
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return super.equals(other) && conditionDeclaration == other.conditionDeclaration && condition == other.condition && statement == other.statement
    }

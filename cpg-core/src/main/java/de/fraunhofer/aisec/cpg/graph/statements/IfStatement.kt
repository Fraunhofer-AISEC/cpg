...
class IfStatement : Statement() {
    ...
    /**
     * The statement that is going to be executed, if the condition is evaluated as true. Usually a
     * [CompoundStatement].
     */
    @SubGraph("AST") var thenStatement: Statement? = null

    /**
     * The statement that is going to be executed, if the condition is evaluated as false. Usually a
     * [CompoundStatement].
     */

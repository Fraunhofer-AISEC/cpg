...
class CompoundStatement : Statement(), StatementHolder {
    ...
    @field:SubGraph("AST")
    private var statements: List<PropertyEdge<Statement>> = ArrayList()
    ...
    override fun getStatementEdges(): List<PropertyEdge<Statement>> {
        return statements
    }

    override fun setStatementEdges(statements: List<PropertyEdge<Statement>>) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return (super.equals(other) &&
            getStatements() == other.getStatements() &&
            propertyEqualsList(statements, other.statements))
    }

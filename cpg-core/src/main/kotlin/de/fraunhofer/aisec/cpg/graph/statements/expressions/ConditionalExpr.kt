 ...
 * valueIfFalse`;
 */
class ConditionalExpr : Expression(), ArgumentHolder, BranchingNode, HasType.TypeObserver {
    @AST var condition: Expression = ProblemExpr("could not parse condition expression")

...
open class MethodDeclaration internal constructor(ctx: TranslationContext) :
     ...
     * (usually into a [ParameterDeclaration]). This is also important because from the "outside"
     * the method only has the remaining arguments, when called (e.g., `object.foo("myarg1")`).
     *

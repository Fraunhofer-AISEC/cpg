...
class TryStmt : Statement() {
    ...
    var resources by PropertyEdgeDelegate(TryStmt::resourceEdges)

    @AST var tryBlock: CompoundStmt? = null

    @AST var finallyBlock: CompoundStmt? = null
    ...
    var catchClauses by PropertyEdgeDelegate(TryStmt::catchClauseEdges)

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is TryStmt) return false

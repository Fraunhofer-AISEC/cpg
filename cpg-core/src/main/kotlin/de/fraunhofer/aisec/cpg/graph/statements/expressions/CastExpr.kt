...
class CastExpr : Expression(), ArgumentHolder, HasType.TypeObserver {
    @AST
    var expression: Expression = ProblemExpr("could not parse inner expression")
        set(value) {
    ...
    companion object {
        private val log = LoggerFactory.getLogger(CastExpr::class.java)
    }
}

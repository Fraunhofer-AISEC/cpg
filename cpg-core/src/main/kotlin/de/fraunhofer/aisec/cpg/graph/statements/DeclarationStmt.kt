 ...
 * [DeclarationStmt].
 */
open class DeclarationStmt : Statement() {
    /**
    ...
    override var declarations by PropertyEdgeDelegate(DeclarationStmt::declarationEdges)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is DeclarationStmt) return false

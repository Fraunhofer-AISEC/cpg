...
class ScopeManager : ScopeProvider {
    ...
    /** The current method in the active scope tree, this ensures that 'this' keywords are mapped correctly
     * if a method contains a lambda or other types of function declarations
     * */
    val currentMethod: MethodDeclaration?
        get() = this.firstScopeOrNull {scope:Scope? -> scope?.astNode is MethodDeclaration }?.astNode as? MethodDeclaration

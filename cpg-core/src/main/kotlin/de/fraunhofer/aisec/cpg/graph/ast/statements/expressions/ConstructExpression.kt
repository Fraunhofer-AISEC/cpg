...
class ConstructExpression : CallExpression() {
    /**
     * The link to the [ast.declarations.ConstructorDeclaration]. This is populated by the
    ...
    /** The [ast.declarations.Declaration] of the type this expression instantiates. */
    @PopulatedByPass(SymbolResolver::class)

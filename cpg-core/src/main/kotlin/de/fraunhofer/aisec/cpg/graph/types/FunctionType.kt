...
import de.fraunhofer.aisec.cpg.graph.declarations.Func.Companion.BRACKET_LEFT
import de.fraunhofer.aisec.cpg.graph.declarations.Func.Companion.BRACKET_RIGHT
import de.fraunhofer.aisec.cpg.graph.declarations.Func.Companion.COMMA
import de.fraunhofer.aisec.cpg.graph.declarations.Func.Companion.WHITESPACE
...
constructor(
    ...
    companion object {
        /** This helper function computes a [FunctionType] out of an existing [Func]. */
        @JvmStatic
        fun computeType(
            func: Func,
        ...
        /**
         * This helper function builds a function signature out of an existing [Func] and potential
         * return types.
         *
         ...
         * `string`.
         */
        fun buildSignature(func: Func, returnTypes: List<Type>): String =
            func.name.localName +

 ...
 * and is connected via the INVOKES edge to its [ast.declarations.FunctionDeclaration].
 */
open class CallExpression :
     ...
     * its type to lookup the necessary [ast.declarations.OperatorDeclaration].
     */

...
class EnumDecl : Declaration() {
    ...
    @AST
    var entryEdges: MutableList<PropertyEdge<EnumConstantDecl>> = ArrayList()
    ...
    var entries by PropertyEdgeDelegate(EnumDecl::entryEdges)

    var superTypes by PropertyEdgeDelegate(EnumDecl::superTypeEdges)

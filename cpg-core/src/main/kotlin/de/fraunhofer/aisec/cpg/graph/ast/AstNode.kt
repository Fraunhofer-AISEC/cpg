 ...
 * such as [de.fraunhofer.aisec.cpg.graph.ast.statements.Statement]s,
 * [de.fraunhofer.aisec.cpg.graph.ast.statements.expressions.Expression]s,
 * [de.fraunhofer.aisec.cpg.graph.ast.declarations.Declaration]s, etc.
 */
abstract class AstNode : Node() {

    /**
     * Virtual property to return a list of the node's children. Uses the
     * [de.fraunhofer.aisec.cpg.helpers.SubgraphWalker] to retrieve the appropriate nodes.
     *
     * Note: This only returns the *direct* children of this node. If you want to have *all*
     * children, e.g., a flattened AST, you need to call
     * [de.fraunhofer.aisec.cpg.graph.allChildren].
     *

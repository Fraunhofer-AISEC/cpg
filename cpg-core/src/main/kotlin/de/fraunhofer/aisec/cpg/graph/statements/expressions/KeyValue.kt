...
class KeyValue : Expression(), ArgumentHolder {
    ...
    @Relationship("KEY") var keyEdge = astEdgeOf<Expression>(Problem("missing key"))
    /**
    ...
    @Relationship("VALUE") var valueEdge = astEdgeOf<Expression>(Problem("missing value"))

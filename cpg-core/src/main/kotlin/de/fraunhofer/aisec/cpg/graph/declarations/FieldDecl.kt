...
/**
 * Declaration of a field within a [RecordDecl]. It contains the modifiers associated with the field
 * as well as an initializer [Expression] which provides an initial value for the field.
 */
class FieldDecl : VariableDecl() {

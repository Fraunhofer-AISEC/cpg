...
/**
 * Represents access to a member of a [RecordDecl], such as `obj.property`. Another common use-case
 * is access of a member function (method) as part of the [MemberCallExpr.callee] property of a
 * [MemberCallExpr].
 */
class MemberExpr : Reference(), HasBase {
    @AST
    override var base: Expression = ProblemExpr("could not parse base expression")
        set(value) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is MemberExpr) return false

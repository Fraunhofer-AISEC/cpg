 ...
 *   as part of a [NewExpr].
 * * In Java, it is the initializer of a [NewExpr].
 */
class ConstructExpr : CallExpr() {
    /**
     * The link to the [ConstructorDecl]. This is populated by the
     * [de.fraunhofer.aisec.cpg.passes.CallResolver] later.
     */
    @PopulatedByPass(CallResolver::class)
    var constructor: ConstructorDecl? = null
        get() =
        ...
        set(value) {
            ...
            if (value != null) {
                invokes = listOf(value as FunctionDecl)
            }
        }

    @AST var anoymousClass: RecordDecl? = null
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is ConstructExpr) return false

 ...
 * accurate as possible when propagating types, the [InitializerListExpr.type] property MUST be set
 * before adding any values to [InitializerListExpr.initializers].
 */
class InitializerListExpr : Expression(), ArgumentHolder, HasType.TypeObserver {
    ...
    var initializers by PropertyEdgeDelegate(InitializerListExpr::initializerEdges)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is InitializerListExpr) return false

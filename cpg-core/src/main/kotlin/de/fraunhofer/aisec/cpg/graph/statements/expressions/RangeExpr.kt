 ...
 * [SubscriptionExpr] as the [SubscriptionExpr.subscriptExpression].
 *
 ...
 * ```
 *
 * In C/C++ this can be also part of a [InitializerExpr], as part of a GCC extension:
 * ```c
 * int a[] = { [0...4] = 1 };
 * ```
 *
...
class RangeExpr : Expression() {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is RangeExpr) return false

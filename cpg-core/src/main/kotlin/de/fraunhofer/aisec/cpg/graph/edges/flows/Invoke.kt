...
/** This edge class denotes the invocation of a [Func] by a [Call]. */
@RelationshipEntity
class Invoke(
    start: Node,
    end: Func,
...
class Invokes<NodeType : Func>(
    thisRef: Node,
    override var mirrorProperty: KProperty<MutableCollection<Invoke>>,
    outgoing: Boolean = true,
) :
    EdgeList<Func, Invoke>(thisRef = thisRef, init = ::Invoke, outgoing = outgoing),
    MirroredEdgeCollection<Func, Invoke> {

...
open class VariableDecl : ValueDecl(), HasInitializer, HasType.TypeObserver {

    /**
     * We need a way to store the templateParameters that a [VariableDecl] might have before the
     * [ConstructExpr] is created.
     *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return if (other !is VariableDecl) {
            false

...
/**
 * The value evaluator tries to evaluate the (constant) value of an [de.fraunhofer.aisec.cpg.graph.expressions.Expression] basically by
 * following DFG edges until we reach a [de.fraunhofer.aisec.cpg.graph.expressions.Literal]. It also evaluates simple binary operations, such
...
open class ValueEvaluator(
     ...
     * basically the case if the base of the subscript expression is a list of [de.fraunhofer.aisec.cpg.graph.expressions.KeyValue] s.
     */

...
/**
 * Tries to infer a [Func] or a [Method] from a [Call]. This will return an empty list, if inference
 ...
 */
internal fun Pass<*>.tryFunctionInference(call: Call, result: CallResolutionResult): List<Func> {
...
/** This function tries to infer a missing [Func] from a function pointer usage. */
...
/**
 * Creates an inferred [Func] for each suitable [Type] (which points to a [Record]).
 *

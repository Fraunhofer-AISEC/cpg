...
/**
 * Tries to infer a [de.fraunhofer.aisec.cpg.graph.ast.declarations.NamespaceDeclaration] from a [Name]. This will return `null`, if inference was
...
/**
 * Tries to infer a [de.fraunhofer.aisec.cpg.graph.ast.declarations.RecordDeclaration] from an unresolved [Type]. This will return `null`, if
...
/**
 * Tries to infer a [de.fraunhofer.aisec.cpg.graph.ast.declarations.VariableDeclaration] (or [de.fraunhofer.aisec.cpg.graph.ast.declarations.FieldDeclaration]) out of a [Reference]. This will
 ...
 * - Inference of a [de.fraunhofer.aisec.cpg.graph.ast.declarations.FieldDeclaration] if we have a language that allows implicit receivers, are
 *   inside a function and the ref is not qualified. This is then forwarded to [tryFieldInference].
 * - Inference of a top-level [de.fraunhofer.aisec.cpg.graph.ast.declarations.VariableDeclaration] on a namespace level (this is not yet
 *   implemented)
 * - Inference of a global [de.fraunhofer.aisec.cpg.graph.ast.declarations.VariableDeclaration] in the [GlobalScope].
...
/**
 * Tries to infer a [de.fraunhofer.aisec.cpg.graph.ast.declarations.FieldDeclaration] from an unresolved [MemberExpression] or [Reference] (if the
...
/**
 * Tries to infer a [de.fraunhofer.aisec.cpg.graph.ast.declarations.FunctionDeclaration] or a [de.fraunhofer.aisec.cpg.graph.ast.declarations.MethodDeclaration] from a [CallExpression]. This
 ...
 * - a [de.fraunhofer.aisec.cpg.graph.ast.declarations.MethodDeclaration] in a record using [tryMethodInference]
 *
 ...
 * infer a [de.fraunhofer.aisec.cpg.graph.ast.declarations.MethodDeclaration] inside the [RecordDeclaration] or if this is a call to a global

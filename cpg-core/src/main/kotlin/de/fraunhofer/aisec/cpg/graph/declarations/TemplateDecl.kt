...
abstract class TemplateDecl : Declaration(), DeclarationHolder {
    ...
    val parameters by PropertyEdgeDelegate(TemplateDecl::parameterEdges)
    ...
    val parametersWithDefaults: List<Declaration>
        get() {
            ...
            for (declaration in parameters) {
                if (
                    (declaration is TypeParamDecl && declaration.default != null) ||
                        (declaration is ParameterDecl && declaration.default != null)
                ) {
    ...
    fun addParameter(parameterizedType: TypeParamDecl) {
    ...
    fun addParameter(nonTypeTemplateParamDeclaration: ParameterDecl) {
    ...
    fun removeParameter(parameterizedType: TypeParamDecl?) {
        parameterEdges.removeIf { it.end == parameterizedType }
    }

    fun removeParameter(nonTypeTemplateParamDeclaration: ParameterDecl?) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as TemplateDecl

 ...
 * appearance a namespace declaration can contain [FunctionDecl] and [RecordDecl] similar to a
 * [RecordDecl] and the semantic difference between NamespaceDeclaration and [RecordDecl] lies in
 * the non-instantiability of a namespace.
 *
 * The name property of this node need to be a FQN for property resolution.
 */
class NamespaceDecl : Declaration(), DeclarationHolder, StatementHolder {
    /**
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is NamespaceDecl) return false
    ...
    override var statements: List<Statement> by PropertyEdgeDelegate(NamespaceDecl::statementEdges)
}

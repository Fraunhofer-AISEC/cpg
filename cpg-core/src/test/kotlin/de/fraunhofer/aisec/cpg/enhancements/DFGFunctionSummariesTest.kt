...
class DFGFunctionSummariesTest {
    ...
    fun testMatching() {
        ...
        val listAddAllTwoArgs = code.dMethods["test.List.addAll"]
        ...
        val specialListAddAllTwoArgs =
            code.dMethods("test.SpecialList.addAll").first {
        ...
        val verySpecialListAddAllSpecializedArgs = code.dMethods["test.VerySpecialList.addAll"]
        ...
        val randomTypeAddAllTwoArgs = code.dMethods["random.Type.addAll"]
    ...
    fun testPropagateArguments() {
        ...
        val main = dfgTest.dFunctions["main"]
        assertNotNull(main)

        val memcpy = dfgTest.dFunctions["memcpy"]
        assertNotNull(memcpy)
        val param0 = memcpy.parameters[0]
        val param1 = memcpy.parameters[1]

        val call = main.dCalls["memcpy"]
        assertNotNull(call)
        ...
        val variableA = main.dVariables["a"]
        ...
        val returnA = main.descendants<ReturnStatement>().singleOrNull()?.returnValue as? Reference

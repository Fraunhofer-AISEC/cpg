...
class InferenceTest {
    ...
    fun testNestedNamespace() {
        ...
        with(result) {
            val java = result.allNamespaces["java"]
            assertNotNull(java)
            assertLocalName("java", java)

            val javaLang = result.allNamespaces["java.lang"]
            ...
            val javaLangString = result.allRecords["java.lang.String"]

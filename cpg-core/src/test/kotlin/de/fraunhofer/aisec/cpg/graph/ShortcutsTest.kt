...
class ShortcutsTest {
    ...
    @Test
    fun testCalls() {
        val actual = shortcutClassResult.dCalls

        val expected = mutableListOf<CallExpression>()
        val classDecl = shortcutClassResult.dRecords["ShortcutClass"]
    ...
    fun testCallsByName() {
        ...
        val expected = mutableListOf<CallExpression>()
        val classDecl = result.dRecords["ShortcutClass"]
        assertNotNull(classDecl)
    ...
    fun testCallersOf() {
        ...
        val expected = mutableListOf<FunctionDeclaration>()
        val main = classDecl.dFunctions["main"]
        assertNotNull(main)

        val scRefs = main.dRefs("sc")
        scRefs.forEach {
            assertNotNull(it)
            assertLocalName("ShortcutClass", it.type)
        }

        val printCall = main.dCalls["print"]

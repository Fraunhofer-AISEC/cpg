...
class FluentTest {
    ...
    fun test() {
        ...
        assertEquals("then", printf.arguments[0]<de.fraunhofer.aisec.cpg.graph.ast.statements.expressions.Literal<*>>()?.value)
        ...
        assertNotNull(printf)
        assertEquals("elseIf", printf.arguments[0]<de.fraunhofer.aisec.cpg.graph.ast.statements.expressions.Literal<*>>()?.value)

        printf = elseIf.elseStatement.calls["printf"]
        assertNotNull(printf)
        assertEquals("else", printf.arguments[0]<de.fraunhofer.aisec.cpg.graph.ast.statements.expressions.Literal<*>>()?.value)

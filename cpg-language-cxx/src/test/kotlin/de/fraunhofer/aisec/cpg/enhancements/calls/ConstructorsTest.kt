...
internal class ConstructorsTest : BaseTest() {
    ...
    fun testCPP() {
        ...
        assertNotNull(a1)
        assertTrue(a1.initializer is Construct)

        val a1Initializer = a1.initializer as Construct
        assertEquals(noArg, a1Initializer.constructor)

        val a2 = findByUniqueName(variables, "a2")
        assertNotNull(a2)
        assertTrue(a2.initializer is Construct)

        val a2Initializer = a2.initializer as Construct
        assertEquals(singleArg, a2Initializer.constructor)

        val a3 = findByUniqueName(variables, "a3")
        assertNotNull(a3)
        assertTrue(a3.initializer is Construct)

        val a3Initializer = a3.initializer as Construct
        assertEquals(twoArgs, a3Initializer.constructor)

        val a4 = findByUniqueName(variables, "a4")
        assertNotNull(a4)
        assertTrue(a4.initializer is Construct)

        val a4Initializer = a4.initializer as Construct
        assertEquals(noArg, a4Initializer.constructor)

        val a5 = findByUniqueName(variables, "a5")
        assertNotNull(a5)
        assertTrue(a5.initializer is Construct)

        val a5Initializer = a5.initializer as Construct
        assertEquals(singleArg, a5Initializer.constructor)

        val a6 = findByUniqueName(variables, "a6")
        assertNotNull(a6)
        assertTrue(a6.initializer is Construct)

        val a6Initializer = a6.initializer as Construct
        assertEquals(twoArgs, a6Initializer.constructor)

        val a7 = findByUniqueName(variables, "a7")
        assertNotNull(a7)
        assertTrue(a7.initializer is New)
        assertTrue((a7.initializer as New).initializer is Construct)

        val a7Initializer = (a7.initializer as New).initializer as Construct
        assertEquals(noArg, a7Initializer.constructor)

        val a8 = findByUniqueName(variables, "a8")
        assertNotNull(a8)
        assertTrue(a8.initializer is New)
        assertTrue((a8.initializer as New).initializer is Construct)

        val a8Initializer = (a8.initializer as New).initializer as Construct
        assertEquals(noArg, a8Initializer.constructor)

        val a9 = findByUniqueName(variables, "a9")
        assertNotNull(a9)
        assertTrue(a9.initializer is New)
        assertTrue((a9.initializer as New).initializer is Construct)

        val a9Initializer = (a9.initializer as New).initializer as Construct
        assertEquals(singleArg, a9Initializer.constructor)

        val a10 = findByUniqueName(variables, "a10")
        assertNotNull(a10)
        assertTrue(a10.initializer is New)
        assertTrue((a10.initializer as New).initializer is Construct)

        val a10Initializer = (a10.initializer as New).initializer as Construct
    ...
    fun testCPPFullDefault() {
        ...
        assertNotNull(d1)
        assertTrue(d1.initializer is Construct)

        val d1Initializer = d1.initializer as Construct
        ...
        assertTrue(d2.initializer is Construct)

        val d2Initializer = d2.initializer as Construct
        ...
        assertTrue(d3.initializer is Construct)

        val d3Initializer = d3.initializer as Construct
    ...
    fun testCPPPartialDefault() {
        ...
        assertTrue(e1.initializer is Construct)
        val e1Initializer = e1.initializer as Construct
        ...
        assertTrue(e2.initializer is Construct)
        val e2Initializer = e2.initializer as Construct
        ...
        assertTrue(e3.initializer is Construct)
        val e3Initializer = e3.initializer as Construct
    ...
    fun testCPPImplicitCast() {
        ...
        assertTrue(i1.initializer is Construct)

        val i1Constructor = i1.initializer as Construct
        ...
        assertTrue(h1.initializer is Construct)

        val h1Constructor = h1.initializer as Construct

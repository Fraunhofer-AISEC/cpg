...
class CXXAmbiguitiesTest {
     ...
     * this is a [ast.statements.expressions.CallExpression] 2) If A is a type, this is a [ast.statements.expressions.CastExpression]
     */
    @Test
     ...
     * [ast.statements.expressions.MemberCallExpression] 2) if B is a function pointer, this is a [ast.statements.expressions.CallExpression].
     *

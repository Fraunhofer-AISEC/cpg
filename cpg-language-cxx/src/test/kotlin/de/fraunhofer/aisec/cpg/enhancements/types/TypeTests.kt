...
internal class TypeTests : BaseTest() {
    ...
    fun testCommonTypeTestCpp() {
        ...
        with(CXXLanguageFrontend(ctx, CPPLanguage())) {
            ...
            val root = assertNotNull(result.dRecords["Root"]).toType()
            val level0 = assertNotNull(result.dRecords["Level0"]).toType()
            val level1 = assertNotNull(result.dRecords["Level1"]).toType()
            val level1b = assertNotNull(result.dRecords["Level1B"]).toType()
            val level2 = assertNotNull(result.dRecords["Level2"]).toType()
            val unrelated = assertNotNull(result.dRecords["Unrelated"]).toType()
    ...
    fun testCommonTypeTestCppMultiInheritance() {
        ...
        val root = assertNotNull(result.dRecords["Root"]).toType()
        val level0 = assertNotNull(result.dRecords["Level0"]).toType()
        val level0b = assertNotNull(result.dRecords["Level0B"]).toType()
        val level1 = assertNotNull(result.dRecords["Level1"]).toType()
        val level1b = assertNotNull(result.dRecords["Level1B"]).toType()
        val level1c = assertNotNull(result.dRecords["Level1C"]).toType()
        val level2 = assertNotNull(result.dRecords["Level2"]).toType()
        val level2b = assertNotNull(result.dRecords["Level2B"]).toType()
